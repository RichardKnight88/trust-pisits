    ...
    <>
      <section className="business-container">
        <div className="business-box">
          <div className="business-brand">
            ...
            <h4 className="pilis">Trust Pistis reviews get you closer <br /> &nbsp; to your customers and power <br /> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;your business forward</h4>
      ...
      <section className="number-reviews">
        <div className="first-number">
          ...
          <p>Over 6.9 billion Trust Pistis review impressions <br /> every month </p>
        </div>
        <div className="second-number">
          <h1>4 million</h1>
          <p><b>new reviews per month</b></p>
          <p>4 million new reviews are posted on Trust Pistis <br /> each month </p>
        </div>
        <div className="third-number">
          <h1>Every second</h1>
          <p><b>somebody shares a new review on Trust Pistis</b></p>
          <p>More than 529,000 websites are reviewed <br /> on Trust Pistis </p>
        </div>
      </section>
        ...
        <div className="customer-confidence">
          <div className="first-confidence">
            <div className="confidence-box">
              <h1><b>Create customer confidence<br /> with Trust Pistis</b></h1>
              <p>Built on honesty and transparency, Trust Pistis is the people&apos;s<br />choice for reviews</p>
              <p>With over 529,000 businesses reviewed and 1.1 trillion <br /> ratings and reviews displayed in google annually, companies <br /> use Trust Pistis to establish credibility and improve their reputation</p>
            </div>
            <Link to="/home">
